...
from .utils import _, normalize_id, I18NService
...
@XBlock.needs("i18n")
@XBlock.needs('user')
class EOCJournalXBlock(StudioEditableXBlockMixin, XBlock, I18NService):
    """
    An XBlock that allows learners to download their activity after they finish their course.
    """
    ...
    def student_view(self, context=None):
        ...
        fragment.add_content(
            loader.render_django_template('templates/eoc_journal.html', context,
